...
export class App extends Component {
  ...
  onThemeChange(event) {
    ...
    themeElement.setAttribute(
      "href",
      themeElement.getAttribute("href").replace(this.state.theme, event.theme)
    );
    this.setState({
      theme: event.theme,
  ...
  componentDidMount() {
    if (this.isOutdatedIE()) {
      this.showcaseToast.show({
        ...
        detail:
          "Although PrimeReact supports IE11, ThemeSwitcher in this application cannot be not fully supported by your browser. Please use a modern browser for the best experience of the showcase.",
        life: 6000,
      });
    }
  }
      ...
      <div className={wrapperClassName}>
        ...
        >
          <div className="layout-content">
            ...
            <AppChangelogDialog
              visible={this.state.changelogActive}
              searchVal={this.state.searchVal}
              onHide={this.hideChangelogDialog}
            />
