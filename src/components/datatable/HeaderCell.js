...
export class HeaderCell extends Component {
    ...
    if (this.props.columnProps.sortable) {
      ...
      if (
        ...
        this.props.onSort({
          originalEvent: event,
          sortField:
            this.props.columnProps.sortField || this.props.columnProps.field,
    ...
    if (this.props.columnProps.filter && this.props.onFilter) {
      ...
      this.filterTimeout = setTimeout(() => {
        this.props.onFilter({
          value: filterValue,
          field:
            this.props.columnProps.filterField || this.props.columnProps.field,
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const filterField =
      nextProps.columnProps.filterField || nextProps.columnProps.field;
    const value =
      nextProps.filters && nextProps.filters[filterField]
        ? nextProps.filters[filterField].value
        : null;

    return {
      filterValue: value !== null ? value : "",
      badgeVisible:
        nextProps.multiSortMeta && nextProps.multiSortMeta.length > 1,
    };
  }
    ...
    if (this.props.columnProps.sortable) {
      let sortIcon = sorted
        ? sortOrder < 0
          ...
          : "pi-sort-amount-up-alt"
        : "pi-sort-alt";
      let sortIconClassName = classNames(
  ...
  renderSortBadge(sortMetaDataIndex) {
    if (sortMetaDataIndex !== -1 && this.state.badgeVisible) {
      return (
        <span className="p-sortable-column-badge">{sortMetaDataIndex + 1}</span>
      );
    }
  ...
  render() {
    ...
    if (
      this.props.columnProps.filter &&
      this.props.renderOptions.renderFilter
    ) {
      filterElement = this.props.columnProps.filterElement || (
        <InputText
    ...
    if (
      this.props.columnProps.selectionMode === "multiple" &&
      this.props.renderOptions.renderHeaderCheckbox
    ) {
      headerCheckbox = (
        <RowCheckbox
    ...
    if (this.props.renderOptions.filterOnly) {
      return (
        <th
          ...
          className={classNames(
            "p-filter-column",
            this.props.columnProps.filterHeaderClassName
          )}
          style={
            this.props.columnProps.filterHeaderStyle ||
            this.props.columnProps.style
          }
      ...
      let multiSortMetaData =
        sortMetaDataIndex !== -1
          ? this.props.multiSortMeta[sortMetaDataIndex]
          : null;
      let singleSorted =
        this.props.sortField !== null
      ...
      let sorted =
        this.props.columnProps.sortable && (singleSorted || multipleSorted);
      let className = classNames(
        ...
        this.props.columnProps.headerClassName ||
          this.props.columnProps.className
      );
      ...
      return (
        <th
          ref={(el) => (this.el = el)}
          tabIndex={
            this.props.columnProps.sortable
              ? this.props.columnProps.tabIndex
              : null
          }
          className={className}
          style={
            this.props.columnProps.headerStyle || this.props.columnProps.style
          }
