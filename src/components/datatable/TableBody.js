...
export class TableBody extends Component {
  ...
  onRowToggle(event) {
    ...
    if (dataKey) {
      let dataKeyValue = String(
        ObjectUtils.resolveFieldData(event.data, dataKey)
      );
      expandedRows = this.props.expandedRows
        ? { ...this.props.expandedRows }
        : {};
  ...
  isRowExpanded(row) {
    ...
    if (dataKey) {
      ...
      return (
        this.props.expandedRows && this.props.expandedRows[dataKeyValue] != null
      );
    } else {
  ...
  renderRowGroupHeader(rowData, index) {
    ...
    if (
      this.props.rowGroupMode === "subheader" &&
      this.props.expandableRowGroups
    ) {
      content = (
        <RowTogglerButton
  ...
  render() {
    ...
    if (this.props.value && this.props.value.length) {
      ...
      let endIndex = this.props.virtualScroll
        ? startIndex + rpp * 2
        : startIndex + rpp || this.props.value.length;
      ...
      for (let i = startIndex; i < endIndex; i++) {
        ...
        let selected = selectionEnabled
          ? this.isSelected(this.props.value[i])
          : false;
        ...
        let isRowGroupExpanded =
          this.props.expandableRowGroups &&
          hasSubheaderGrouping &&
          rowGroupHeaderExpanded;
        ...
        if (
          expanded &&
          !(hasSubheaderGrouping && this.props.expandableRowGroups)
        ) {
        ...
        if (
          hasSubheaderGrouping &&
          (!this.props.expandableRowGroups || isRowGroupExpanded)
        ) {
          let currentRowFieldData = ObjectUtils.resolveFieldData(
            rowData,
            this.props.groupField
          ...
          if (
            ...
            currentRowFieldData !== nextRowFieldData
          ) {
