...
export class BodyCell extends Component {
  ...
  onBlur() {
    if (
      this.props.editMode !== "row" &&
      this.state.editing &&
      this.props.editorValidatorEvent === "blur"
    ) {
      this.switchCellToViewMode(true);
    }
  }
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (
      nextProps.editMode === "row" &&
      nextProps.editing !== prevState.editing
    ) {
      return {
    ...
    if (this.props.editMode !== "row" && this.container && this.props.editor) {
      ...
      if (this.state.editing) {
        ...
        if (
          ...
          !focusable.hasAttribute("data-isCellEditing")
        ) {
  ...
  render() {
    ...
    let cellClassName = classNames(
      this.props.bodyClassName || this.props.className,
      {
    ...
    if (this.props.expander) {
      let iconClassName = classNames(
        "p-row-toggler-icon pi pi-fw p-clickable",
        {
      ...
      if (showReorder) {
        let reorderIcon = classNames(
          "p-table-reorderablerow-handle",
          this.props.rowReorderIcon
        );
      ...
      if (this.state.editing && this.props.editor) {
        ...
        if (this.props.body)
          ...
          content = ObjectUtils.resolveFieldData(
            this.props.rowData,
            this.props.field
          );
      }
