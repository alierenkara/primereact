      ...
      <div>
        <div className="content-section introduction">
          <AppInlineHeader changelogText="dataTable">
            <h1>
              DataTable <span>ColumnGroup</span>
            </h1>
            <p>
              Columns can be grouped at header and footer using
              headerColumnGroup and footerColumnGroup components that both
              define an array of columns each having colspan and rowspan.
            </p>
          </AppInlineHeader>
        </div>
        ...
        <div className="content-section implementation">
          <div className="card">
            ...
            >
              ...
              <Column
                field="lastYearSale"
                body={this.lastYearSaleBodyTemplate}
              />
              <Column
                field="thisYearSale"
                body={this.thisYearSaleBodyTemplate}
              />
              <Column
              ...
              <Column
                ...
                body={this.thisYearProfitBodyTemplate}
              />
            </DataTable>
          </div>
        </div>
