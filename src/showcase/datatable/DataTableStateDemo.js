    ...
    return (
      <span className="p-input-icon-left">
        ...
        <InputText
          type="search"
          onInput={(e) =>
            this.setState({ [`${globalFilterKey}`]: e.target.value })
          }
  ...
  render() {
    ...
    const representativeFilter = (
      <MultiSelect
        ...
        onChange={(e) => this.setState({ selectedRepresentative: e.value })}
        optionLabel="name"
        optionValue="name"
        placeholder="All"
    ...
    const statusFilter = (
      <Dropdown
        ...
        onChange={(e) => this.setState({ selectedStatus: e.value })}
        ...
        <div className="content-section implementation">
          <div className="card">
            ...
            <DataTable
              ...
              rows={10}
              header={header1}
              selection={this.state.selectedCustomer1}
              onSelectionChange={(e) =>
                this.setState({ selectedCustomer1: e.value })
              }
          ...
          <div className="card">
            ...
            <DataTable
              ...
              rows={10}
              header={header2}
              selection={this.state.selectedCustomer2}
              onSelectionChange={(e) =>
                this.setState({ selectedCustomer2: e.value })
              }
              selectionMode="single"
              dataKey="id"
              stateStorage="local"
          ...
          <div className="card">
            ...
            <DataTable
              ...
              rows={10}
              header={header3}
              selection={this.state.selectedCustomer3}
              onSelectionChange={(e) =>
                this.setState({ selectedCustomer3: e.value })
              }
              selectionMode="single"
              dataKey="id"
              stateStorage="custom"
              customSaveState={this.onCustomSaveState}
              customRestoreState={this.onCustomRestoreState}
              emptyMessage="No customers found."
            >
              <Column
                field="name"
