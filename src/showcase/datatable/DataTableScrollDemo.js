...
export class DataTableScrollDemo extends Component {
  ...
  componentDidMount() {
    ...
    this.customerService
      .getCustomersXLarge()
      .then((data) =>
        this.setState({ inmemoryData: data }, this.loadVirtualCustomers)
      );
      ...
      <div>
        <div className="content-section introduction">
          <AppInlineHeader changelogText="dataTable">
            <h1>
              DataTable <span>Scroll</span>
            </h1>
            <p>
              Data scrolling with fixed header is available horizontally,
              vertically or both. ScrollHeight and ScrollWidth values can either
              be fixed pixels or percentages. Certain columns can be fixed as
              well. Virtual Scrolling mode is available to deal with large
              datasets by loading data on demand during scrolling.
            </p>
          </AppInlineHeader>
        </div>
