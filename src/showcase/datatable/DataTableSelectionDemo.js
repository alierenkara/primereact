      ...
      <div>
        <div className="content-section introduction">
          <AppInlineHeader changelogText="dataTable">
            ...
            <p>
              ...
              a row. Selected rows are bound to the selection property and
              onRowSelect-onRowUnselect events are provided as optional
              callbacks. In addition built-in radio button and checkbox based
              selections are available as alternatives.
            </p>
          </AppInlineHeader>
        </div>
        ...
        <div className="content-section implementation">
          ...
          <div className="card">
            <h5>Single</h5>
            <p>
              In single mode, a row is selected on click event of a row. If the
              row is already selected then the row gets unselected.
            </p>
            <DataTable
          ...
          <div className="card">
            <h5>Multiple</h5>
            <p>
              In multiple mode, selection binding should be an array. For touch
              enabled devices, selection is managed by tapping and for other
              devices metakey or shiftkey are required. Setting metaKeySelection
              property as false enables multiple selection without meta key.
            </p>
            <DataTable
              value={this.state.products}
              ...
              onSelectionChange={(e) =>
                this.setState({ selectedProducts1: e.value })
              }
            ...
            <DataTable
              ...
              onSelectionChange={(e) =>
                this.setState({ selectedProducts2: e.value })
              }
              selectionMode="multiple"
              dataKey="id"
          ...
          <div className="card">
            ...
            <DataTable
              ...
              onSelectionChange={(e) =>
                this.setState({ selectedProduct2: e.value })
              }
              selectionMode="single"
              dataKey="id"
          ...
          <div className="card">
            <h5>RadioButton</h5>
            <p>
              Single selection can also be handled using radio buttons by
              enabling the selectionMode property of column as "single".
            </p>
            <DataTable
              value={this.state.products}
              selection={this.state.selectedProduct3}
              onSelectionChange={(e) =>
                this.setState({ selectedProduct3: e.value })
              }
              dataKey="id"
            >
              <Column
          ...
          <div className="card">
            ...
            <DataTable
              ...
              onSelectionChange={(e) =>
                this.setState({ selectedProducts3: e.value })
              }
              dataKey="id"
            >
              <Column
